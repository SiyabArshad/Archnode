...
export default function GroupRequests({navigation,route}) {
  ...
  return (
    <Screen>
    <ScreenHeader screenname='Group Requests'/>
     <View style={{flex:1,justifyContent:"space-between"}}>
     <SearchBox val={search} changefunc={(e)=>setsearch(e)} style={{marginVertical:rp(2),borderWidth:0,backgroundColor:colors.lightgrey}} placeholder='Search Group'/>
...
>
     <ButtonFilled text={"Join Group"} style={{borderRadius:rp(5),marginVertical:rp(2)}} textstyle={{textTransform:"capitalize"}}/>
     <ButtonOutline text={"Reject"} style={{borderRadius:rp(5),marginBottom:rp(2)}}/>
</View>
</View>
 </Screen>
  )
